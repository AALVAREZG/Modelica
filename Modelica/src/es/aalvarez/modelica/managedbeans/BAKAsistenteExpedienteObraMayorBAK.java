...
@ManagedBean
@ViewScoped 
public class BAKAsistenteExpedienteObraMayorBAK implements Serializable {
 
    /**
	 * 
	 */
	private static final long serialVersionUID = 8109547409497533679L;
	final  Logger logger = LogManager.getLogger(BAKAsistenteExpedienteObraMayorBAK.class);
	...
	@PostConstruct
	private void init(){
		logger.debug("init Asistente Expediente Obra Mayor");
		//campos.crearCampos();
    	...
    	if (facesContext.getExternalContext().getRequestParameterMap().get("modo")!=null){
    		String modo = facesContext.getExternalContext().getRequestParameterMap().get("modo");
    	   	...
    	   	logger.debug("¿Modo edicion? :" + String.valueOf(this.editar));
	}
        ...
        if (dbSession!=null){
            try {
              ...
              this.licenciaOM = service.selectByExampleWithBLOBs(eExample).get(0);
            	...
            	logger.error("Error obtenerExpedienteDesdeId obra Mayor ",e);       
	    	...
	    	logger.error("Error obtenerExpedienteDesde Id obra Mayor, sesion de base de datos nula ");
	    }
	}
        ...
        if (dbSession!=null){
            try {
              ...
              dbSession.commit(true);
            	...
            	logger.error("Error actualizarEstadoLicencia obra Mayor ",e);           
            }finally{
...
//        obtenerEstadoDeFase();
	...
	public void guardar() {
        ...
        int generatedID = -1;
        licenciaOM.setTipoExpediente("OBRAMAYOR");
	...
	public void actualizar(){
        ...
        if (dbSession!=null){
            try {
              logger.debug("Actualizando Expediente (Licencia Obra Mayor) ... " + this.licenciaOM.getId()+" Expte: " + licenciaOM.getExpediente()+" - "+licenciaOM.getAnyo());
              service = dbSession.getMapper(ExpedienteMapper.class);
//              ExpedienteExample eExample = new ExpedienteExample();
//              eExample.createCriteria().andIdEqualTo(this.licenciaOM.getId());
              ...
              dbSession.commit(true);
            	...
            	logger.error("Error actualizar Licencia obra Mayor ",e);           
            }finally{
